        ...
        <div class="border-right" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush">
            <a
              ...
              class="list-group-item list-group-item-action {{ (request()->is('admin/toko*')) ? 'active' : '' }} ">Toko</a> --}}
              ...
              class="list-group-item list-group-item-action {{ (request()->is('admin/transaction*')) ? 'active' : '' }}  ">Transaction</a>
